    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-4 rounded-full text-lg font-semibold transition-colors shadow-xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow">
              ...
              <div className="p-8">
                <h3 className="text-3xl font-bold text-zinc-900 mb-4">Highly Intelligent</h3>
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow">
              ...
              <div className="p-8">
                <h3 className="text-3xl font-bold text-zinc-900 mb-4">Gentle & Calm</h3>
                <p className="text-zinc-600 text-lg leading-relaxed">
            ...
            <div className="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow">
              ...
              <div className="p-8">
                <h3 className="text-3xl font-bold text-zinc-900 mb-4">Fiercely Loyal</h3>
                <p className="text-zinc-600 text-lg leading-relaxed">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center p-8 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl">
            ...
            <h3 className="text-xl font-bold text-zinc-900 mb-3">Super Hearing</h3>
          ...
          <div className="text-center p-8 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl">
            <div className="text-6xl mb-4">💪</div>
            <h3 className="text-xl font-bold text-zinc-900 mb-3">Surprisingly Strong</h3>
            <p className="text-zinc-600">
          ...
          <div className="text-center p-8 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl">
            <div className="text-6xl mb-4">🎭</div>
            <h3 className="text-xl font-bold text-zinc-900 mb-3">Expressive</h3>
            <p className="text-zinc-600">
          ...
          <div className="text-center p-8 bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl">
            ...
            <h3 className="text-xl font-bold text-zinc-900 mb-3">Natural Guardians</h3>
            <p className="text-zinc-600">
      ...
      <section className="py-24 px-6 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button className="bg-white text-blue-600 px-10 py-5 rounded-full text-lg font-semibold hover:bg-blue-50 transition-colors shadow-2xl">
              Find Your Donkey
            </button>
      ...
      <footer className="bg-zinc-900 text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-zinc-400 mb-8">
